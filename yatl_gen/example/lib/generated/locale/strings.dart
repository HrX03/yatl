...
class CommonLocaleStrings extends LocaleStrings {
  const CommonLocaleStrings._(YatlCore core) : super(core);
...
class MainPageLocaleStrings extends LocaleStrings {
  const MainPageLocaleStrings._(YatlCore core) : super(core);
...
class NotePageLocaleStrings extends LocaleStrings {
  const NotePageLocaleStrings._(YatlCore core) : super(core);
...
class AboutLocaleStrings extends LocaleStrings {
  const AboutLocaleStrings._(YatlCore core) : super(core);
...
class SearchLocaleStrings extends LocaleStrings {
  const SearchLocaleStrings._(YatlCore core) : super(core);
...
class DrawingLocaleStrings extends LocaleStrings {
  const DrawingLocaleStrings._(YatlCore core) : super(core);
...
class SetupLocaleStrings extends LocaleStrings {
  const SetupLocaleStrings._(YatlCore core) : super(core);
...
class BackupRestoreLocaleStrings extends LocaleStrings {
  const BackupRestoreLocaleStrings._(YatlCore core) : super(core);
...
class MiscellaneousLocaleStrings extends LocaleStrings {
  const MiscellaneousLocaleStrings._(YatlCore core) : super(core);
